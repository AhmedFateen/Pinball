...
void Interface::drawScoreMultiplier(Vector2D center, float radius,float multiplier)
{
    ...
    sf::Text text;
    text.setFont(arial);
    text.setString("x"+ std::to_string(multiplier).substr(0, 3));
    text.setCharacterSize(static_cast<unsigned>(radius / 2));
